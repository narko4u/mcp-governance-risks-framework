...
docs-ci validates that all Markdown files have balanced code fences and all structured files parse on every pull request and push to main.

Run the same checks locally:

```sh
Run docs-ci validation script locally
```
